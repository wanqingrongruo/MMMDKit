...
这个目录包含一个 AppKit macOS demo 源码文件。Demo 推荐通过 Swift Package Manager 接入本地 `MMMDKit` package。
...
4. 将 `MMMDKitMacDemoApp.swift` 和 `../Shared/DemoMarkdownSamples.swift` 加入 App target。
